  ...
  return (
    <>
      ...
      <StyledTabs onChange={index => setTabIndex(index)}>
        <StyledTabList>
          <StyledTab>My Trips</StyledTab>
          <StyledTab>Current Trips</StyledTab>
          <StyledTab>Completed Trips</StyledTab>
        </StyledTabList>
        <StyledTabPanels>
          ...
          <StyledTabPanel> {tabIndex === 2 && <FavoriteListings />}</StyledTabPanel>
        </StyledTabPanels>
      </StyledTabs>
    </>
  );
